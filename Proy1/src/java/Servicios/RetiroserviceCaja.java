 ...
 * @author sebas
 */
@WebServlet(name = "RetiroserviceCaja", urlPatterns = {"/RetiroserviceCaja", "/Administrador", "/RetiroCaja"})
public class RetiroserviceCaja extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String cantidad = request.getParameter("retiro");
        ...
        if (num_cuenta != null && num_cuenta.length() > 1) {
            ...
            if (c != null) {
                c.setSaldo_final(c.getSaldo_inicial() - retiro);
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/vista/RetiroCaja.jsp");
            dispatcher.forward(request, response);
        }
    }
